...
export default function App() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('edu_uige_candidates_2026_v2');
    if (stored) {
      try {
      ...
      setCandidates(CANDIDATOS_MOCK);
      localStorage.setItem('edu_uige_candidates_2026_v2', JSON.stringify(CANDIDATOS_MOCK));
    }
  }, []);
  ...
  const handleAddCandidate = (newCand: Candidato) => {
    ...
    localStorage.setItem('edu_uige_candidates_2026_v2', JSON.stringify(updated));
  };
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            <div className="flex items-center space-x-2.5">
              ...
              <p className="font-medium leading-normal text-blue-850">
                <strong className="text-blue-950 font-extrabold mr-1.5">[Despacho Nº 247/2026]:</strong> Inscrições abertas de 15/07 a 04/08/2026, nas Direcções Municipais da Educação. Prova escrita marcada para 02/09/2026. Dois regimes: Professor (396 vagas) e Técnico Médio de 3ª Classe (50 vagas).
              </p>
            </div>
            <button 
